...
class RfqSupplierDispatch extends Model
{
    ...
    protected $fillable = ['rfq_id', 'rfq_supplier_invoice', 'supplier_id', 'unique_id', 'courier_name', 'courier_phone_number', 'delivery_medium', 'cse_status', 'cse_material_aaceptance', 'supplier_status', 'cse_comment', 'comment'];
