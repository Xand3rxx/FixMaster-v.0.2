<aside class="aside aside-fixed" id="sidebarMenu">
    ...
    <ul class="nav nav-aside">
        ...
        <li class="nav-item with-sub {{ Route::currentRouteNamed('cse.requests.index', 'cse.request_details', 'cse.warranty_details','cse.requests.show', 'cse.warranty_claims','cse.warranty_claims', 'cse.warranty_claim_details') ? 'active show' : '' }}">
