  ...
  <div class="aside-body">
    ...
    <ul class="nav nav-aside">
      ...
      <li class="nav-item with-sub">
        ...
        <ul>
          <li class=""><a href="{{ route('admin.inbox', app()->getLocale()) }}">Inbox</a></li>
          <li class=""><a href="{{ route('admin.outbox', app()->getLocale()) }}">Sent</a></li>
        </ul>
      </li>
      ...
      <li class="nav-item with-sub">
        ...
        <ul>
          <li class=""><a href="{{ route('admin.template', app()->getLocale()) }}">Email & SMS</a></li>
