...
@section('title', Auth::user()->type->role->name.' Dashboard' ?? 'Customer Service Executive Dashboard')
  ...
  <div class="container pd-x-0">
    <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
      <div>
        ...
        <h4 class="mg-b-0 tx-spacing--1">Welcome to Fix<span style="color: #E97D1F;">Master</span> {{ Auth::user()->type->role->name}} Dashboard</h4>
