                ...
                <div class="d-none d-trf">
                    ...
                    <div class="form-row tool-request">
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control custom-select @error('tool_id') is-invalid @enderror tool_id"
                                id="tool_id" name="tool_id[]">
                                <option value="" selected>Select...</option>
                                @foreach ($tools as $tool)
                                    <option value="{{ $tool->id }}"
                                        {{ old('tool_id[0]') == $tool->id ? 'selected' : '' }}
                        ...
                        <div class="form-group quantity-section col-md-2">
                            ...
                            <input type="number"
                                class="form-control @error('tool_quantity[0]') is-invalid @enderror tool_quantity"
                        ...
                        <div class="form-group col-md-2 mt-1">
                            <button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 mt-4 add-trf"
                                type="button"><i class="fas fa-plus" class="wd-10 mg-r-5"></i></button>
                        </div>
                    </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-1 col-md-1 col-sm-1">
                                                <div class="custom-control custom-radio mt-2">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input" id="technician{{ $loop->iteration }}" name="technician_user_uuid"  value="{{ $technicain['user']['uuid'] }}">
                                                        <label class="custom-control-label"  for="technician{{ $loop->iteration }}"></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
