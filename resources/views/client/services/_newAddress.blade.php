                    ...
                    <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="tel" maxlength="11" id="phone-number" class="form-control phone" placeholder="Phone Number :" />
                                        </div>
                                    </div>
                                    <!--end col-->
                                    ...
                                    <div class="col-12">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="text" id="street-address" class="form-control user_address" placeholder="Full address of contact :" />
                                        </div>
                                    </div>
                                    <!--end col-->
