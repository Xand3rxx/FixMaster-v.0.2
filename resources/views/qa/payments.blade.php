            ...
            <div class="d-sm-flex">
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <h4 class="tx-20 tx-sm-18 tx-md-20 tx-normal tx-rubik mg-b-0">5</h4>
                </div>
              </div>
            ...
            <table class="table table-hover mg-b-0" id="basicExample">
              ...
              <tbody>
                {{-- @foreach ($payments as $payment) --}}
                  ...
                  <td class="tx-medium">458235792</td>
                    <td class="tx-medium">FixMaster</td>
                    <td class="tx-medium">₦7,000</td>
                    <td class="tx-medium">Bank Transfer</td>
                    <td class="tx-medium">Successful</td>
                    <td class="text-medium">January 17th 2021, 7:40:07pm</td>
                  </tr>

                  <tr>
                    <td class="tx-color-03 tx-center">2</td>
                  <td class="tx-medium">REF-094009623412 job</td>
                  <td class="tx-medium">45898760</td>
                    <td class="tx-medium">FixMaster</td>
                    <td class="tx-medium">₦4,800</td>
                    <td class="tx-medium">Bank Transfer</td>
                    <td class="tx-medium">Completed</td>
                    <td class="text-medium">Mar 21, 2020, 3:30pm</td>
                  </tr>

                  <tr>
                    <td class="tx-color-03 tx-center">3</td>
                  <td class="tx-medium">REF-237290223123</td>
                  <td class="tx-medium">45803748</td>
                    <td class="tx-medium">FixMaster</td>
                    <td class="tx-medium">₦2,500</td>
                    <td class="tx-medium">Bank Transfer</td>
                    <td class="tx-medium">Completed</td>
                    <td class="text-medium">Feb 25, 2020, 8:17am</td>
                  </tr>

                  <tr>
                    <td class="tx-color-03 tx-center">4</td>
                  <td class="tx-medium">REF-234094623496 job</td>
                  <td class="tx-medium">45801176</td>
                    <td class="tx-medium">FixMaster</td>
                    <td class="tx-medium">₦1,950</td>
                    <td class="tx-medium">Bank Transfer</td>
                    <td class="tx-medium">Completed</td>
                    <td class="text-medium">Jan 18, 2020, 7:30pm</td>
                  </tr>

                  <tr>
                    <td class="tx-color-03 tx-center">5</td>
                  <td class="tx-medium">REF-234094623496 job</td>
                  <td class="tx-medium">48100876</td>
                    <td class="tx-medium">FixMaster</td>
                    <td class="tx-medium">₦6,000</td>
                    <td class="tx-medium">Bank Transfer</td>
                    <td class="tx-medium">Completed</td>
                    <td class="text-medium">Jan 8, 2020, 6:18am</td>
                  </tr>
                {{-- @endforeach --}}
              </tbody>
            </table>
