            ...
            <table class="table table-hover mg-b-0" id="basicExample">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="tx-medium">REF-234094623496 job</td>
                  <td class="tx-medium">Bolaji LAwal</td>
                  <td class="tx-medium">Raji Gbenga</td>
                  <td class="tx-medium">Muyiwa Shade</td>
                  <td class="text-medium text-center">ongoing</td>
                  <td class="text-medium text-center">January 17th 2021, 7:40:07pm</td>
                </tr>

                <tr>
                    <td class="tx-color-03 tx-center">2</td>
                    <td class="tx-medium">REF-987011623496 job</td>
                    <td class="tx-medium">Michael Smith</td>
                    <td class="tx-medium">Raji Queenth</td>
                    <td class="tx-medium">Laide Shade</td>
                    <td class="text-medium text-center">Completed</td>
                    <td class="text-medium text-center">January 01th 2021, 2:15:07pm</td>
                  </tr>

                  <tr>
                    <td class="tx-color-03 tx-center">3</td>
                    <td class="tx-medium">REF-234094620722 job</td>
                    <td class="tx-medium">Tosin Gbenga</td>
                    <td class="tx-medium">Raji Bimbo</td>
                    <td class="tx-medium">Lekan John</td>
                    <td class="text-medium text-center">Completed</td>
                    <td class="text-medium text-center">December 03th 2020, 9:40:07pm</td>
                  </tr>
                {{-- @endforeach --}}
