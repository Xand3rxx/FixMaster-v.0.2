            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Prospective Customer Service Executive List</li>
                    </ol>
                </nav>
                ...
                <div class="card mg-b-10">
                    <div class="card-header pd-t-20 d-sm-flex align-items-start justify-content-between bd-b-0 pd-b-0">
                        <div>
                            ...
                            <p class="tx-13 tx-color-03 mg-b-0">This table displays a list of all FixMaster Prospective Customer Service Executive.</p>
                        </div>
                        ...
                        <table class="table table-hover mg-b-0" id="basicExample">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="tx-medium">{{ Str::title($cse['form_data']['first_name_cse'] ." ". $cse['form_data']['last_name_cse']) }}</td>
                                    <td class="tx-medium">{{ $cse['form_data']['email_cse'] }}</td>
                                    <td class="tx-medium">{{ $cse['form_data']['phone_cse'] }}</td>
                                    <td class="tx-medium">{{ Str::title($cse['form_data']['gender_cse']) }}</td>

                                    <td class="tx-medium"> {{ Carbon\Carbon::parse($cse['form_data']['date_of_birth_cse'], 'UTC')->isoFormat('MMMM Do YYYY')}} </td>
