          ...
          <td class=" text-center">
            <div class="dropdown-file">
              ...
              @if($service->id > '1')
                ...
                @if(empty($service->deleted_at)) 
                  <a href="{{ route('admin.categories.deactivate', ['category'=>$service->uuid, 'locale'=>app()->getLocale()]) }}" class="dropdown-item details text-warning" title="Deactivate {{ $service->name}}"><i class="fas fa-ban"></i> Deactivate</a>
                @else
                ...
                <a href="{{ route('admin.categories.delete', ['category'=>$service->uuid, 'locale'=>app()->getLocale()]) }}" class="dropdown-item details text-danger" title="Delete {{ $service->name}}"><i class="fas fa-trash"></i> Delete</a>
