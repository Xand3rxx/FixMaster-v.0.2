            ...
            @if(!empty($subStatus->name))
              <div class="dropdown-file">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <a data-url="{{ route('admin.statuses.delete', ['status'=>$subStatus->uuid, 'locale'=>app()->getLocale()]) }}" class="dropdown-item delete-entity text-danger" title="Delete {{ $subStatus->name}}" style="cursor: pointer;"><i class="fas fa-trash"></i> Delete</a>
