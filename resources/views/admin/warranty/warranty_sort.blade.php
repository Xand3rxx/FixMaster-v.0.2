...
@section('title', 'Warranty Transactions')
        ...
        <div class="card mg-b-10">
          ...
          <div class="table-responsive">
            <div class="row mt-1 mb-1 ml-1 mr-1">
                <div class="col-md-4">
                    <input value="{{ route("admin.warranty_transaction_sort", app()->getLocale()) }}" type="hidden" id="route">
              ...
              <div id="sort_table">
              @include('admin.warranty.warranty_transaction')
              </div>
