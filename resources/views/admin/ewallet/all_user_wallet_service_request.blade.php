                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">E-Wallet Service Request</li>
                        </ol>
                    </nav>
                    <h4 class="mg-b-0 tx-spacing--1">All Client E-Wallet Service Request</h4>
                </div>
                ...
                <div class="col-lg-12 col-xl-12 mg-t-10">
                    <div class="card mg-b-10">
                        <div class="card-header pd-t-20 d-sm-flex align-items-start justify-content-between bd-b-0 pd-b-0">
                            <div>
                                <h6 class="mg-b-5">E-Wallet Service Request as of {{ date('M, d Y') }}</h6>
                                <p class="tx-13 tx-color-03 mg-b-0">This table displays a list of all your E-Wallet Service Request on FixMaster.</p>
                            </div>
                                        ...
                                        <tr>
                                           ...
                                           <td class=" text-center">
                                                ...
                                                <div class="dropdown-file">
                                                    ...
                                                    <a href="{{ route('admin.summary', [ 'transaction'=>$transaction['id'], 'locale'=>app()->getLocale() ]) }}" class="dropdown-item details text-primary"><i class="far fa-user"></i> Refund</a>
