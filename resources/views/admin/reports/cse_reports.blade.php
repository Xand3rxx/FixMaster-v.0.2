        ...
        <div>
          <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.index', app()->getLocale()) }}">Dashboard</a></li>
              <li class="breadcrumb-item active" aria-current="page">CSE Reports</li>
            </ol>
          </nav>
          <h4 class="mg-b-0 tx-spacing--1">All CSE Report</h4>
        </div>
      </div>
        ...
        <div class="col-lg-12 col-xl-12 mg-t-10">
          <div class="card mg-b-10">
            <div class="card-header pd-t-20 d-sm-flex align-items-start justify-content-between bd-b-0 pd-b-0">
              <div>
                <h6 class="mg-b-5">CSE Reports</h6>
                <p class="tx-13 tx-color-03 mg-b-0">Use the select dropdowns to select your report options.</p>
              </div>
            ...
            <div class="table-responsive">
              <div class="row mt-1 mb-1 ml-1 mr-1">
                ...
                <input value="{{ route("admin.sort_cse_reports", app()->getLocale()) }}" type="hidden" id="route">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="custom-select" id="activity_log_type">
                            ...
                            <option value="Errors">Assigned Jobs</option>
                            <option value="Login">Amount Earned</option>
                            <option value="Logout">All CSE's</option>
                            <option value="Others">Ratings History</option>
                            <option value="Payments">Account Statement</option>
