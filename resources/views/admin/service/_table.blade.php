        ...
        <tr>
          ...
          <td class=" text-center">
            <div class="dropdown-file">
              ...
              @if($category->status == 1) 
                <a data-url="{{ route('admin.services.deactivate', ['service'=>$category->uuid, 'locale'=>app()->getLocale()]) }}" class="dropdown-item details text-warning deactivate-entity" title="Deactivate {{ $category->name}}" style="cursor: pointer;"><i class="fas fa-ban"></i> Deactivate</a>
              @else
              ...
              @endif
              <a data-url="{{ route('admin.services.delete', ['service'=>$category->uuid, 'locale'=>app()->getLocale()]) }}" class="dropdown-item details text-danger delete-entity" title="Delete {{ $category->name}}" style="cursor: pointer;"><i class="fas fa-trash"></i> Delete</a>
              </div>
            </div>
          </td>
        </tr>
