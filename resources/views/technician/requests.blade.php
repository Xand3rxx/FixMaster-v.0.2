                ...
                <tr>
                  ...
                  <td class=" text-center">
                    <div class="dropdown-file">
                      ...
                      <a href="{{ route('technician.request_details', ['serviceRequests'=>$serviceRequest->service_request_id, 'locale'=>app()->getLocale()]) }}" class="dropdown-item details"><i class="far fa-clipboard"></i> Details</a>
                      <a href="{{ route('technician.request_details', ['serviceRequests'=>$serviceRequest->service_request_id, 'locale'=>app()->getLocale()]) }}" class="dropdown-item details"><i class="far fa-clipboard"></i> Decline</a>
                      <a href="{{ route('technician.request_details', ['serviceRequests'=>$serviceRequest->service_request_id, 'locale'=>app()->getLocale()]) }}" class="dropdown-item details"><i class="far fa-clipboard"></i> Accept</a>
                      <a href="{{ route('technician.request_details', ['serviceRequests'=>$serviceRequest->service_request_id, 'locale'=>app()->getLocale()]) }}" class="dropdown-item details"><i class="far fa-clipboard"></i> Completed</a>
                      </div>
