                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="shadow mt-4 qa-style">
                                        <div class="media-body content ml-3 text-center">
                                            <h5 class="title mb-0 qa">Completed Requests</h5>
                                            <h2 class="qa">10</h2>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="qa-style shadow mt-4">
                                        <div class="media-body content ml-3 text-center">
                                            <h5 class="title mb-0 qa">Pending Consultations</h5>
                                            <h2 class="qa">20</h2>
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="qa-style shadow mt-4">
                                        <div class="media-body content ml-3 text-center">
                                            <h5 class="title mb-0 qa">Completed Consultations</h5>
                                            <h2 class="qa">20</h2>
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="qa-style shadow mt-4">
                                        <div class="media-body content ml-3 text-center">
                                            <h5 class="title mb-0 qa">Payment Received</h5>
                                            <h2 class="qa">20</h2>
                                ...
                                <div class="col-md-4 mt-4">
                                    <div class="qa-style shadow mt-4">
                                        <div class="media-body content ml-3 text-center">
                                            <h5 class="title mb-0 qa">Total Requests</h5>
                                            <h2 class="qa">20</h2>
