                                ...
                                <div class="row pb-4">
                                    <div class="col-lg-4 col-md-5 ml-auto">
                                        <ul class="list-unstyled h5 font-weight-normal mt-4 mb-0">
                                            <li class="text-muted d-flex justify-content-between">Subtotal :<span>₦ {{ number_format($invoice['serviceRequest']['service']['service_charge']) }}</span></li>
                                            ...
                                            <li class="d-flex justify-content-between">Total :<span>₦ {{ number_format($total_cost - $invoice->serviceRequest->price->amount) }}</span></li>
                                        </ul>
                                    </div><!--end col-->
                                </div>
